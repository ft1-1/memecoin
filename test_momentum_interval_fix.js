...
const { MomentumAccelerationTracker } = require('./dist/analysis/momentum/MomentumAccelerationTracker.js');

// Generate test OHLCV data with different intervals
function generateTestData(intervalMinutes, numCandles) {
  const data = [];
...
function testIntervalDetection() {
  ...
  // Mock the MomentumAccelerationSystemComponent interval detection logic
  function detectInterval(ohlcvData) {
